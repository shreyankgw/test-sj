...
export default function Banner() {
  ...
  return (
    <div
      className={`${
        close ? "hidden" : "block"
      } bg-bgInformative relative w-full`}
    >
      <div className="block p-4 text-center">
        <div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
          <div className="text-textPrimary font-semibold body-medium">
            <div className="flex items-center justify-center flex-wrap">
              <span className="flex items-center justify-center flex-nowrap">
                ...
                3 Months of Shopify Trial for $1/month*
              </span>
              ...
              <span className="block sm:ml-2 sm:inline-block">
                <Link
                  ...
                  className="font-bold underline text-textInformative"
                >
                  {" "}
                  Try Shopify
                </Link>
        ...
        <div className="absolute inset-y-0 right-0 pt-1 pr-1 flex items-start sm:pt-3 sm:pr-2 sm:items-start text-brandPrimary">
